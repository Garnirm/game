...
export default {
    data: function () {
        return {
            ...
            resources: [
                ...
                { label: 'Lait', var_amount: 'milk', var_balance: 'production_balance_milk' },
                { label: 'Fromage', var_amount: 'cheese', var_balance: 'production_balance_cheese' },
                { label: 'Viande de boeuf', var_amount: 'beef_meat', var_balance: 'production_balance_beef_meat' },
    ...
    computed: {
        ...
        milk: function () { return this.$store.getters['resources/get_resource']('milk') },
        cheese: function () { return this.$store.getters['resources/get_resource']('cheese') },
        beef_meat: function () { return this.$store.getters['resources/get_resource']('beef_meat') },
        ...
        production_balance_milk: function () { return this.$store.getters['resources/get_production_balance']('milk') },
        production_balance_cheese: function () { return this.$store.getters['resources/get_production_balance']('cheese') },
        production_balance_beef_meat: function () { return this.$store.getters['resources/get_production_balance']('beef_meat') },
